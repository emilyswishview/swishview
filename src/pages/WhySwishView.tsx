...
const WhySwishView: React.FC = () => {
  ...
  const framework = [
    { icon: Search, title: "Discover", text: "Improve how clearly your content is presented, described, and organized." },
    { icon: MousePointerClick, title: "Attract", text: "Improve the factors that can influence viewer clicks." },
    { icon: Clock, title: "Engage", text: "Improve opportunities for meaningful viewing and audience engagement." },
    { icon: Compass, title: "Expand", text: "Improve discoverability across YouTube surfaces and relevant external search." },
  ...
  const timeline = [
    "Individual Experts",
    "Experience Across YouTube Growth Work",
    "Combined Experience",
    "Founded SwishView",
  ...
  const trust = [
    ...
    },
    {
      ...
      text: "Analytics, revenue, upcoming videos, and sponsor discussions are handled confidentially with access limited to what is required.",
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      text: "A dedicated point of contact and clear communication throughout the engagement.",
    },
    {
      icon: BarChart3,
      title: "Transparent Reporting",
      text: "Reporting is built around measurable channel and campaign metrics.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      <SEOHead
        ...
        description="SwishView helps YouTube creators with SEO, content strategy, analytics, optimization, and transparent reporting."
      />
      <Navbar />
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Reveal delay={200}>
              <p className="text-lg md:text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
                Creating great content is only half the journey. If your content, packaging, and audience signals are not aligned, discoverability can be harder. That's where we come in.
              </p>
            </Reveal>
            <Reveal delay={300}>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <Reveal>
              ...
              <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
                <p>
                  Before SwishView was founded, our team had experience working on YouTube growth and content optimization —
                  we were already working with creators and channels.
                </p>
                <p>
                ...
                <p>
                  Creators often had to coordinate multiple specialists — one for SEO, another for
          ...
          <div className="text-center mb-14">
            <Reveal>
              ...
              <p className="text-lg text-gray-600 mt-4 max-w-2xl mx-auto">
                We audit the channel, research its audience and search opportunities, make agreed optimizations,
                track the relevant metrics, and use the results to guide the next round of improvements.
              </p>
            </Reveal>
          </div>
          <div className="flex flex-col items-center">
      ...
      <section className="py-20 bg-gradient-to-br from-pulse-50 via-white to-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-14">
            <Reveal>
              <SectionChip n={7} label="Evidence & Examples" />
              <h2 className="font-display text-3xl md:text-5xl mt-4 text-gray-900">
                Not just numbers. Stories.
              </h2>
              <p className="text-lg text-gray-600 mt-4 max-w-2xl mx-auto">
                Selected case snapshots show the challenge, the work completed, and the reported outcome.
              </p>
            </Reveal>
          </div>
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              {
                problem: "Limited visibility for target search terms",
                change: "SEO review, keyword research, and title optimization",
                result: "Example outcome: improved visibility for selected target queries",
              },
              {
                problem: "Strong content with limited initial reach",
                change: "Thumbnail review, packaging tests, and description optimization",
                result: "Example outcome: stronger reach and viewer response",
              },
              {
                problem: "Channel growth had plateaued",
                change: "Discovery optimization and publishing strategy",
                result: "Example outcome: renewed audience growth during the engagement",
              },
            ].map((c, i) => (
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-14">
            <Reveal>
              <SectionChip n={7} label="Analytics Examples" />
              <h2 className="font-display text-3xl md:text-5xl mt-4 text-gray-900">
                Channel analytics and reporting
              </h2>
              <p className="text-lg text-gray-600 mt-4 max-w-2xl mx-auto">
                Example YouTube Studio views are shown for context. Where client permission is available, supporting case studies will identify the campaign period, work performed, and relevant metrics. Client identities are blurred when required for privacy.
              </p>
            </Reveal>
          </div>
            ...
            {[
              {
                img: analyticsShot1,
                tag: "28-day overview",
                headline: "Views — reported campaign metric",
                sub: "Example analytics view. Specific metrics should be interpreted together with the campaign period, baseline, and work performed.",
              },
              {
                img: analyticsShot2,
                tag: "90-day reach report",
                headline: "Impressions & CTR — reported metrics",
                sub: "Example analytics view. Supporting case-study context should accompany any published performance figures.",
              },
              {
                img: analyticsShot3,
                tag: "6-month audience",
                headline: "Subscriber growth — reported metric",
                sub: "Example analytics view. Results should be evaluated alongside the relevant campaign period and baseline.",
              },
            ].map((s, i) => (
                ...
                <div className={`grid md:grid-cols-5 gap-8 items-center ${i % 2 === 1 ? "md:[&>*:first-child]:order-2" : ""}`}>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="mt-4 flex items-center gap-2 text-xs text-gray-400">
                      ...
                      Creator identity blurred when required for privacy
                    </div>
                  </div>
                </div>
              </Reveal>
          ...
          <Reveal>
            <div className="max-w-4xl mx-auto text-center rounded-[2rem] p-10 md:p-16 bg-gradient-to-br from-pulse-500 to-pulse-700 text-white relative overflow-hidden shadow-elegant-hover">
              ...
              <p className="text-lg md:text-xl opacity-90 mb-8 relative">
                Get a free audit. See where your channel may have opportunities to improve.
              </p>
