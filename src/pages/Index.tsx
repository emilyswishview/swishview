...
import HomeFullRedesign from "@/components/HomeFullRedesign";
import UnsubscribePopup from "@/components/UnsubscribePopup";
import ContactInfoModal from "@/components/policy-modals/ContactInfoModal";
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <Footer />
      <UnsubscribePopup />
      <ContactInfoModal open={contactOpen} onOpenChange={setContactOpen} />
      
      {/* Sticky Contact CTA */}
      <button
        onClick={() => setContactOpen(true)}
        className="fixed bottom-24 right-5 md:bottom-6 md:right-6 z-50 flex min-h-[48px] min-w-[48px] items-center gap-2 rounded-full bg-orange-500 px-5 py-3 text-sm font-semibold text-white shadow-lg hover:bg-orange-600 hover:scale-105 transition-all duration-300"
