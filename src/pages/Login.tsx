...
import { ArrowUp, ChevronLeft, Eye, EyeOff } from "lucide-react";
...
const Login = () => {
  ...
  return (
    <div className="min-h-[100dvh] md:max-h-screen flex relative">
      {/* Mobile back-to-home button */}
      <button
        type="button"
        aria-label="Back to home"
        onClick={() => navigate("/")}
        className="md:hidden absolute top-4 left-4 z-10 flex items-center gap-1.5 h-10 px-3 rounded-full bg-white border border-gray-200 shadow-sm text-gray-700 text-sm font-medium"
      >
        <ChevronLeft className="w-4 h-4" />
        Home
      </button>
      {/* Left Panel - Form */}
      <div className="flex-1 flex items-start md:items-center justify-center p-6 pt-16 md:pt-8 lg:p-1 bg-white overflow-y-auto">
        <div className="w-full max-w-md space-y-5 pb-8 md:pb-0">
          {/* Logo */}
          ...
          <div className="text-center space-y-1">
            ...
            <p className="text-gray-600">
              Sign in to your SwishView account
            </p>
          </div>
