...
const Login = () => {
  ...
  return (
    <div className="min-h-[100dvh] md:max-h-screen flex">
      {/* Left Panel - Form */}
      <div className="flex-1 flex items-start md:items-center justify-center p-6 pt-8 lg:p-1 bg-white overflow-y-auto">
