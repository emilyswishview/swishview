...
const Features = () => {
  ...
  return (
    <section className=" pb-0 relative " id="features" ref={sectionRef}>
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="We promote your videos to genuine viewers through handpicked platforms, social communities, and niche content spaces never bots or fake traffic."
            index={0}
          />
          <FeatureCard
            ...
            description="Our strategy improves watch time, CTR, and engagement, giving the YouTube algorithm the signals it loves. That means long-term visibility, not just a one-time boost."
            index={1}
          />
          <FeatureCard
            ...
            description="Beyond promotion, we help with titles, tags, thumbnails, keywords, and descriptions so your channel is set up to rank in Search and Suggested videos."
            index={2}
          />
          <FeatureCard
            ...
            description="Every creator gets a personalized dashboard with real-time insights into views, subscribers, and performance so you always know what’s working.
"
            index={3}
          />
          <FeatureCard
          ...
          <FeatureCard
            ...
            description="With 24/7 availability across all time zones, our team is always here to support your growth."
            index={5}
          />
        </div>
      </div>
