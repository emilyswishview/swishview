...
const HomeFullRedesign: React.FC = () => {
  ...
  return (
    <div className="w-full">
      {/* ============================ HERO ============================ */}
      <section className="relative pt-24 md:pt-24 pb-8 md:pb-10 overflow-hidden  lg:min-h-screen lg:flex lg:items-center">
        <div
          aria-hidden
          className="absolute -top-40 -right-32 w-[600px] h-[600px] rounded-full  blur-3xl animate-float"
        />
        <div
          aria-hidden
          className="absolute -bottom-40 -left-32 w-[500px] h-[500px] rounded-full  blur-3xl animate-float"
