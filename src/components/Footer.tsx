...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full bg-white py-7 pb-24 md:py-8 md:pb-8">
      <div className="section-container py-0 md:py-8">
        <div className="flex flex-col items-center space-y-5 md:space-y-6">
          ...
          <p className="px-4 text-center text-xs text-gray-600 font-display sm:text-sm">
            Create. Upload. Go Viral! ❤
          </p>
          
          {/* Line 1: page links */}
          <div className="grid w-full max-w-md grid-cols-2 gap-x-4 gap-y-3 text-center text-xs sm:flex sm:max-w-none sm:flex-wrap sm:justify-center sm:gap-4 sm:text-sm">
            <a
              href="/privacy-policy"
          ...
          {/* Copyright line */}
          <div className="w-full border-t border-gray-200 pt-4 text-center text-[11px] leading-5 text-gray-500 font-display sm:text-xs">
