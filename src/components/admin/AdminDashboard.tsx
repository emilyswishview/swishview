...
import { Users, CreditCard, BarChart3, MessageSquare, Mail, Settings, Search, Gift, Globe, UserCog, PenSquare, Clock, Map } from 'lucide-react';
...
import RoadmapsSection from '@/components/admin/RoadmapsSection';
...
const AdminDashboard = () => {
  ...
  const menuItems = [
    ...
    { id: 'coupons', label: 'Bonus Coupons', icon: Gift },
      ...
      { id: 'reports', label: 'Reports', icon: PenSquare },
