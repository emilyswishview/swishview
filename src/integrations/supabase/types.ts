...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      free_report_usage: { Args: { _channel_url: string }; Returns: Json }
      ...
      normalize_channel_key: { Args: { _url: string }; Returns: string }
      ...
      roll_api_quota_day: { Args: never; Returns: undefined }
      show_limit: { Args: never; Returns: number }
      show_trgm: { Args: { "": string }; Returns: string[] }
      submit_free_report_request: {
        Args: { _channel_url: string; _email: string; _phone: string }
        Returns: Json
      }
