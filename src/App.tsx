...
const CallingAgent = React.lazy(() => import("./pages/CallingAgent"));
...
import WhySwishView from "./pages/WhySwishView";
...
const PhoneFinder = React.lazy(() => import("./pages/PhoneFinder"));
      ...
      <QueryClientProvider client={queryClient}>
        ...
        <Route path="/blogs/:creatorSlug" element={<CreatorLanding />} />
          ...
          <Route path="/email-tracker" element={<EmailTracker />} />
           ...
           <Route path="/calling" element={<React.Suspense fallback={<div className="p-8 text-sm text-muted-foreground">Loading…</div>}><CallingAgent /></React.Suspense>} />
          <Route path="/prospects-login" element={<ProspectsLogin />} />
           <Route path="/prospects" element={<React.Suspense fallback={<div className="p-8 text-sm text-muted-foreground">Loading prospects…</div>}><Prospects /></React.Suspense>} />
           <Route path="/prospects/leads" element={<React.Suspense fallback={<div className="p-8 text-sm text-muted-foreground">Loading prospects…</div>}><Prospects /></React.Suspense>} />
           <Route path="/prospects/unqualified" element={<React.Suspense fallback={<div className="p-8 text-sm text-muted-foreground">Loading prospects…</div>}><Prospects /></React.Suspense>} />
           <Route path="/prospects/banned" element={<React.Suspense fallback={<div className="p-8 text-sm text-muted-foreground">Loading prospects…</div>}><Prospects /></React.Suspense>} />
           <Route path="/prospects/calling" element={<React.Suspense fallback={<div className="p-8 text-sm text-muted-foreground">Loading calling leads…</div>}><Prospects /></React.Suspense>} />
           <Route path="/prospects/queue" element={<React.Suspense fallback={<div className="p-8 text-sm text-muted-foreground">Loading queue…</div>}><Prospects /></React.Suspense>} />
           <Route path="/prospects/bounces" element={<React.Suspense fallback={<div className="p-8 text-sm text-muted-foreground">Loading bounces…</div>}><Prospects /></React.Suspense>} />
           ...
           <Route path="/phone" element={<React.Suspense fallback={<div className="p-8 text-sm text-muted-foreground">Loading phone finder…</div>}><PhoneFinder /></React.Suspense>} />
