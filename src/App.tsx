...
const BookConsultation = lazyPage(() => import("./pages/BookConsultation"));
...
const UserUpdate = lazyPage(() => import("./pages/UserUpdate"));
const FreeReport = lazyPage(() => import("./pages/FreeReport"));
            ...
            <TooltipProvider>
              ...
              <React.Suspense fallback={<RouteFallback />}>
                <Routes>
                  ...
                  <Route path="/weekly-report" element={<Navigate to="/free-report" replace />} />
