...
export const PAGE_SEO: PageSEO[] = [
  ...
  },
  {
    ...
    description:
      "Book a free 30-minute consultation with a Swish View growth manager and get a tailored YouTube growth plan for your channel.",
    keywords: "book youtube consultation, youtube growth manager, swish view consultation",
    sitemap: true,
    priority: 0.8,
    changefreq: "monthly",
  },
