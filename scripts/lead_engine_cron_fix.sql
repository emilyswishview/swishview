...
-- The publishable anon JWT below is sufficient for gateway routing because the
-- worker endpoint has verify_jwt=false; the worker uses its server-side client.
-- =====================================================================
