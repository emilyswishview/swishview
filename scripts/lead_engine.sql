...
SELECT cron.schedule(
  ...
  SELECT net.http_post(
    ...
    headers := '{"Content-Type":"application/json","apikey":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im51eGl4aG9vZ29ocWxpZ3pnYmRtIiwiaWF0IjoxNzQ4NTAyODU4LCJleHAiOjIwNjQwNzg4NTh9.SWNqG4qtcgs3zmMOh-89RSTA7nAXdcNbWpFjDYCUCSQ","Authorization":"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im51eGl4aG9vZ29ocWxpZ3pnYmRtIiwiaWF0IjoxNzQ4NTAyODU4LCJleHAiOjIwNjQwNzg4NTh9.SWNqG4qtcgs3zmMOh-89RSTA7nAXdcNbWpFjDYCUCSQ"}'::jsonb,
